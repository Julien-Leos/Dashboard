<template>
  <el-row :gutter="20" class="header bg-primary-dark">
    <el-col :span="18"
      ><h1><nuxt-link to="/">Dashboard</nuxt-link></h1></el-col
    >
    <el-col
      v-show="!$store.state.auth.accessToken"
      :span="6"
      class="header-auth"
    >
    ...
    >
      <nuxt-link to="/home">
        {{ $store.state.auth.userMail.toUpperCase() }}
      </nuxt-link>
